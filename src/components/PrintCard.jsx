...
const PrintCard = ({print}) => {
    ...
    return (
        ...
        <article id="printCard" className="w-2/3 flex flex-col items-center mx-auto mb-24 px-6 bg-white shadow-md rounded-md animate-fade-down animate-once 
        animate-ease-out">
            <img src={print.informacionEstampa.imgurl} alt="Imagen de la estampa" id="printImage" className='mt-4 object-cover w-40'/>

            <div id="printCard-details" className="flex flex-col justify-between items-center mt-4">
                <div id="details-size" className="flex items-center">
                    <h3 className="ml-1 mr-5 text-sm text-center text-black font-paragraph"> {print.informacionEstampa.nombre} </h3> 
                </div>
                ...
                <div id="details-price" className="flex items-center mt-4">
                    ...
                    <h3 className="ml-1 text-sm text-center text-black font-paragraph"> {print.informacionEstampa.precio} </h3>
                </div> 
            </div>  
