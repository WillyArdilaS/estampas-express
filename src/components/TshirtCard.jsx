...
const TshirtCard = ({info}) => {
    ...
    return (
        <article id="tshirtCard" className="w-2/3 flex flex-col items-center mx-auto mb-36 px-6 bg-white shadow-md rounded-md">
            <img src={info.imgurl} alt="Imagen de la camiseta" id="tshirtImage" width="150" height="80" className='mt-4'/>
            ...
            <div id="tshirtCard-details" className="flex flex-col justify-between items-center mt-4">
                <div id="details-size" className="flex items-center">
                    ...
                    <h3 className="ml-1 mr-5 text-sm text-center text-black font-paragraph"> {info.talla} </h3> 
                </div>
                ...
                <div id="details-quantity" className="flex items-center mt-1">
                    ...
                    <h3 className="ml-1 mr-5 text-sm text-center text-black font-paragraph"> {info.cantdisponible} </h3> 
                </div>
